                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 p-8 lg:p-10 rounded-2xl bg-surface-light dark:bg-surface-dark border border-slate-900/5 dark:border-slate-100/5">
                                <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                                    ...
                                    <button className="w-full bg-primary text-white font-bold py-3.5 rounded-lg mt-2 cursor-pointer hover:bg-primary/90 hover:cursor-pointer shadow-lg shadow-primary/20 transition-all active:scale-[0.98]" type="submit">Qeydiyyatı Təsdiqlə</button>
                                </form>
                            </div>
